...
def scaffold_alg(args, epsilon, nets, global_model, party_list_rounds, net_dataidx_map, train_local_dls, test_dl, traindata_cls_counts, device, global_dist, logger):
    best_test_acc=0
    ...
    for round in range(args.comm_round):
        ...
        # Local update
        epsilon, nets_list = local_train_net_scaffold(epsilon, nets_this_round, global_model, c_nets, c_global, args, net_dataidx_map, train_dl=train_local_dls, test_dl=test_dl, device=device, logger=logger)
