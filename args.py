...
def get_args():
    ...
    # log
    parser.add_argument('--log_file_name', type=str, default='fedavg_cifar10_noniid-1_PDP', help='the log file name')
    parser.add_argument('--logdir', type=str, required=False, default="./zxx_my_logs/", help='log directory path')
